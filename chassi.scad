...
// todo this is redundant, pass as parameter
worm_length = 40;
worm_holder_length = 10;

module gear_belt(distance, radius, height, thickness, clearance) {
  t = thickness;
  c = clearance;
...
module bearing_holder(thickness) {
  difference() {
...
module bearing_holders(radius, height, thickness, clearance) {
...
module chassi(gear_distance, gear_radius, gear_height, rod_diameter, thickness, clearance) {
  c = clearance;
  t = thickness;
